...
A global, tree-structured, admin-managed category lookup entries are
classified by. See `account-entries` for how a category is required
for a transaction and optional for a balance adjustment.
