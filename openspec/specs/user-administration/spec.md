...
soft-delete) and admin-only listing of invitations. See `authentication`
for how a disabled or soft-deleted user is blocked at sign-in and session
resolution, and `web-client-settings` for the client surface.
